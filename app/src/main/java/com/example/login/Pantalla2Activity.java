...
public class Pantalla2Activity extends AppCompatActivity  {
       ...
       /* ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this,R.array.spinner_humo,android.R.layout.simple_spinner_item);
        ...
        spinnerHumo.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                //Toast.makeText(Pantalla2Activity.this, ""+humo, Toast.LENGTH_SHORT).show();
            }
        ...
        enviarAviso.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(humo.equals("Seleccione") || vegetacion.equals("Seleccione") || columna.equals("Seleccione")) {
                    Toast.makeText(Pantalla2Activity.this, "Debe seleccionar alguna opcion", Toast.LENGTH_SHORT).show();
                }
                else {
                    Intent datos = new Intent(Pantalla2Activity.this,ValidacionActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem opcion_menu) {
        ...
        if(id == R.id.informacion){
            Toast.makeText(this, "Pasaria a otra activity donde pondria" +
                    "una explicacion de como localizar el incendio", Toast.LENGTH_SHORT).show();
            return true;
        }

        if(id == R.id.salir){
            AlertDialog.Builder alerta = new AlertDialog.Builder(Pantalla2Activity.this);
            alerta.setMessage("¿Desea cerrar sesion?")
                    ...
                    .setPositiveButton("Si", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            mAuth.signOut();
                            startActivity(new Intent(Pantalla2Activity.this,MainActivity.class));
                            finish();
                        }
                    })
